...
```{r}
# load in data
Fits=readRDS('~/Desktop/g_p/gp_SH2_FitBoots.rds')
...
# actually plot em
plot_bootstraps(PFits,113,expression(italic(p)),MaxP,Pbc,Pc)
plot_bootstraps(IFits,36,'Internalizing',MaxI,Ibc,Ic)
plot_bootstraps(EFits,40,'Externalizing',MaxE,Ebc,Ec)

```

```{r}
# load in data
Fits=readRDS('~/Desktop/g_p/gp_SH2_DerivBoots.rds')
# find mean shape and plot it: p
PFits=Fits[,1:114]
IFits=Fits[,115:151]
EFits=Fits[,152:192]
