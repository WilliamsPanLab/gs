...
IFits=Fits[,163:213]
EFits=Fits[,214:260]
SomFits=Fits[,261:277]
AnxFits=Fits[,278:299]
ThoFits=Fits[,300:322]
WitFits=Fits[,323:339]
SocFits=Fits[,340:357]
AttFits=Fits[,358:377]
RulFits=Fits[,378:395]
AggFits=Fits[,396:428]
...
plot_bootstraps(IFits,50,'Internalizing',MaxI,Ibc,Ic)
plot_bootstraps(EFits,46,'Externalizing',MaxE,Ebc,Ec)
# for supplemental figure
plot_bootstraps(SomFits,16,"Somatic",MaxSom,SomBc,SomC)
plot_bootstraps(AnxFits,21,'Anxious Depression',MaxAnx,AnxBc,AnxC)
...
plot_bootstraps(RulFits,17,'Rule Breaking',MaxRul,RulBc,RulC)
