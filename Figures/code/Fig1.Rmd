...
data_melt$Var1 <- rep(seq(1, 127), nrow(data))
...
ggplot(data=dervPlotDf) + geom_raster(aes(x = seq, y = .5, fill = sig_deriv))+
      ...
      scale_fill_gradient2(low = "#377eb8", midpoint = 0, mid = "white",
                           high = "#e41a1c",limits = c(min(-.032),max(0.032)))+theme_minimal()+xlim(c(0,MaxP))
# for int
# get straightfoward of segment where 99% is over 0 or under
...
ggplot(data=dervPlotDf) + geom_raster(aes(x = seq, y = .5, fill = sig_deriv))+
      theme(panel.spacing = unit(-.01,"cm")) +
      scale_fill_gradient2(low = "#377eb8", midpoint = 0, mid = "white",
                           high = "#e41a1c",limits = c(min(-.032),max(0.032)))+theme_minimal()+xlim(c(0,MaxI))
...
ggplot(data=dervPlotDf) + geom_raster(aes(x = seq, y = .5, fill = sig_deriv))+
      theme(panel.spacing = unit(-.01,"cm")) +
      scale_fill_gradient2(low = "#377eb8", midpoint = 0, mid = "white",
                           high = "#e41a1c",limits = c(min(-.032),max(0.032)))+theme_minimal()+xlim(c(0,MaxE))
