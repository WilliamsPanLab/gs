...
plot_bootstraps_par(pov_Som,20,'Pov. child Somatic',MaxSom)
# nonpoverty child p
npov_Som=pNpFits1[,471:484]
plot_bootstraps_par(npov_Som,20,'Npov. child Somatic',MaxSom)
# both merged
plot<-plot_bootstraps_pnp(pov_Som,npov_Som,20,'child Somatic',MaxSom)
plot + theme(plot.margin = margin(r = 30,l=5,t=5,b=5))
...
```{r}
# Social
pov_Soc=pNpFits1[,609:628]
MaxSoc=quantile(as.numeric(masterdf$cbcl_scr_syn_social_r), probs = 0.99)
plot_bootstraps_par(pov_Soc,19,'Pov. Social',MaxSoc)
# nonpoverty child p
npov_Soc=pNpFits1[,629:648]
plot_bootstraps_par(npov_Soc,19,'Npov. Social',MaxSoc)
# both merged
plot<-plot_bootstraps_pnp(pov_Soc,npov_Soc,19,'child Social',MaxSoc)
plot + theme(plot.margin = margin(r = 30,l=15,t=5,b=5))
...
pov_Att=pNpFits1[,649:667]
MaxAtt=quantile(as.numeric(masterdf$cbcl_scr_syn_attention_r), probs = 0.99)
plot_bootstraps_par(pov_Att,18,'Pov. Attn.',MaxAtt)
# nonpoverty child p
npov_Att=pNpFits1[,668:686]
plot_bootstraps_par(npov_Att,18,'Npov. Attn.',MaxAtt)
# both merged
plot<-plot_bootstraps_pnp(pov_Att,npov_Att,18,'child Attention',MaxAtt)
plot + theme(plot.margin = margin(r = 30,l=5,t=5,b=5))
...
```{r}
# Rule breaking
pov_RB=pNpFits1[,687:719]
MaxRB=quantile(as.numeric(masterdf$cbcl_scr_syn_rulebreak_r), probs = 0.99)
plot_bootstraps_par(pov_RB,32,'Pov. Rules',MaxRB)
# nonpoverty child p
npov_RB=pNpFits1[,720:752]
plot_bootstraps_par(npov_RB,32,'Npov. child Rules',MaxRB)
# both merged
plot<-plot_bootstraps_pnp(pov_RB,npov_RB,32,'child Rules',MaxRB)
plot + theme(plot.margin = margin(r = 30,l=5,t=5,b=5))
...
# both merged
plot<-plot_bootstraps_pnp(pov_Agg,npov_Agg,45,'child Aggression',MaxAgg)
plot + theme(plot.margin = margin(r = 30,l=5,t=5,b=5))
...
#DevExpl1[6251:7500,]=DevExpl6
DevExpl[7501:8750,]=DevExpl7[7501:8750,]
DevExpl[8751:10000,]=DevExpl8[8751:10000,]
# temp ###
DevExpl=DevExpl[-c(2501:3750), ]
DevExpl=DevExpl[-c(5001:6250), ]
...
# temp ###
Grades=Grades[-c(2501:3750), ]
Grades=Grades[-c(5001:6250), ]

# plot observed vs expected - p factor
ggplot(Grades[1:7500,],aes(x=p_permutedTstats_AvB))+geom_density(size=1.5)+geom_vline(xintercept = Grades$p_permutedTstats_AvB[7501],size=2,color='#BC3754')+theme_classic(base_size=18)+ylab('')+xlab('p-factor a vs. b')+guides(y="none")+scale_x_continuous()
print(sum(abs(Grades$p_permutedTstats_AvB[1:7500]>abs(Grades$p_permutedTstats_AvB[7501]))))/7500

ggplot(Grades[1:7500,],aes(x=p_permutedTstats_AvC))+geom_density(size=1.5)+geom_vline(xintercept = Grades$p_permutedTstats_AvC[7501],size=2,color='#BC3754')+theme_classic(base_size=18)+ylab('')+xlab('p-factor a vs. c')+guides(y="none")+scale_x_continuous()
print(sum(abs(Grades$p_permutedTstats_AvC[1:7500]>abs(Grades$p_permutedTstats_AvC[7501]))))/7500


ggplot(Grades[1:7500,],aes(x=p_permutedTstats_AvD))+geom_density(size=1.5)+geom_vline(xintercept = Grades$p_permutedTstats_AvD[7501],size=2,color='#BC3754')+theme_classic(base_size=18)+ylab('')+xlab('p-factor a vs. failing')+guides(y="none")+scale_x_continuous()
print(sum(abs(Grades$p_permutedTstats_AvD[1:7500]>abs(Grades$p_permutedTstats_AvD[7501]))))/7500


ggplot(Grades[1:7500,],aes(x=p_permutedTstats_BvC))+geom_density(size=1.5)+geom_vline(xintercept = Grades$p_permutedTstats_BvC[7501],size=2,color='#BC3754')+theme_classic(base_size=18)+ylab('')+xlab('p-factor b vs. c')+guides(y="none")+scale_x_continuous()
print(sum(abs(Grades$p_permutedTstats_BvC[1:7500]>abs(Grades$p_permutedTstats_BvC[7501]))))/7500


ggplot(Grades[1:7500,],aes(x=p_permutedTstats_BvD))+geom_density(size=1.5)+geom_vline(xintercept = Grades$p_permutedTstats_BvD[7501],size=2,color='#BC3754')+theme_classic(base_size=18)+ylab('')+xlab('p-factor b vs. failing')+guides(y="none")+scale_x_continuous()
print(sum(abs(Grades$p_permutedTstats_BvD[1:7500]>abs(Grades$p_permutedTstats_BvD[7501]))))/7500


#ggplot(Grades[1:7500,],aes(x=p_permutedTstats_CvD))+geom_density(size=1.5)+geom_vline(xintercept = Grades$p_permutedTstats_CvD[7501],size=2,color='#BC3754')+theme_classic(base_size=18)+ylab('')+xlab('p-factor c vs. failing')+guides(y="none")+scale_x_continuous()

# plot observed vs expected - internalizing
ggplot(Grades[1:7500,],aes(x=int_permutedTstats_AvB))+geom_density(size=1.5)+geom_vline(xintercept = Grades$int_permutedTstats_AvB[7501],size=2,color='#BC3754')+theme_classic(base_size=18)+ylab('')+xlab('internalizing a vs. b')+guides(y="none")+scale_x_continuous()
print(sum(abs(Grades$int_permutedTstats_AvB[1:7500]>abs(Grades$int_permutedTstats_AvB[7501]))))/7500


ggplot(Grades[1:7500,],aes(x=int_permutedTstats_AvC))+geom_density(size=1.5)+geom_vline(xintercept = Grades$int_permutedTstats_AvC[7501],size=2,color='#BC3754')+theme_classic(base_size=18)+ylab('')+xlab('internalizing a vs. c')+guides(y="none")+scale_x_continuous()
print(sum(abs(Grades$int_permutedTstats_AvC[1:7500]>abs(Grades$int_permutedTstats_AvC[7501]))))/7500


ggplot(Grades[1:7500,],aes(x=int_permutedTstats_AvD))+geom_density(size=1.5)+geom_vline(xintercept = Grades$int_permutedTstats_AvD[7501],size=2,color='#BC3754')+theme_classic(base_size=18)+ylab('')+xlab('internalizing a vs. failing')+guides(y="none")+scale_x_continuous()
print(sum(abs(Grades$int_permutedTstats_AvD[1:7500]>abs(Grades$int_permutedTstats_AvD[7501]))))/7500


ggplot(Grades[1:7500,],aes(x=int_permutedTstats_BvC))+geom_density(size=1.5)+geom_vline(xintercept = Grades$int_permutedTstats_BvC[7501],size=2,color='#BC3754')+theme_classic(base_size=18)+ylab('')+xlab('internalizing b vs. c')+guides(y="none")+scale_x_continuous()
print(sum(abs(Grades$int_permutedTstats_BvC[1:7500]>abs(Grades$int_permutedTstats_BvC[7501]))))/7500


ggplot(Grades[1:7500,],aes(x=int_permutedTstats_BvD))+geom_density(size=1.5)+geom_vline(xintercept = Grades$int_permutedTstats_BvD[7501],size=2,color='#BC3754')+theme_classic(base_size=18)+ylab('')+xlab('internalizing b vs. failing')+guides(y="none")+scale_x_continuous()
print(sum(abs(Grades$int_permutedTstats_BvD[1:7500]>abs(Grades$int_permutedTstats_BvD[7501]))))/7500


#ggplot(Grades[1:7500,],aes(x=int_permutedTstats_CvD))+geom_density(size=1.5)+geom_vline(xintercept = Grades$int_permutedTstats_CvD[7501],size=2,color='#BC3754')+theme_classic(base_size=18)+ylab('')+xlab('internalizing c vs. failing')+guides(y="none")+scale_x_continuous()

# plot observed vs expected - externalizing
ggplot(Grades[1:7500,],aes(x=ext_permutedTstats_AvB))+geom_density(size=1.5)+geom_vline(xintercept = Grades$ext_permutedTstats_AvB[7501],size=2,color='#BC3754')+theme_classic(base_size=18)+ylab('')+xlab('externalizing a vs. b')+guides(y="none")+scale_x_continuous()
print(sum(abs(Grades$ext_permutedTstats_AvB[1:7500]>abs(Grades$ext_permutedTstats_AvB[7501]))))/7500


ggplot(Grades[1:7500,],aes(x=ext_permutedTstats_AvC))+geom_density(size=1.5)+geom_vline(xintercept = Grades$ext_permutedTstats_AvC[7501],size=2,color='#BC3754')+theme_classic(base_size=18)+ylab('')+xlab('externalizing a vs. c')+guides(y="none")+scale_x_continuous()
print(sum(abs(Grades$ext_permutedTstats_AvC[1:7500]>abs(Grades$ext_permutedTstats_AvC[7501]))))/7500


ggplot(Grades[1:7500,],aes(x=ext_permutedTstats_AvD))+geom_density(size=1.5)+geom_vline(xintercept = Grades$ext_permutedTstats_AvD[7501],size=2,color='#BC3754')+theme_classic(base_size=18)+ylab('')+xlab('externalizing a vs. failing')+guides(y="none")+scale_x_continuous()
print(sum(abs(Grades$ext_permutedTstats_AvD[1:7500]>abs(Grades$ext_permutedTstats_AvD[7501]))))/7500


ggplot(Grades[1:7500,],aes(x=ext_permutedTstats_BvC))+geom_density(size=1.5)+geom_vline(xintercept = Grades$ext_permutedTstats_BvC[7501],size=2,color='#BC3754')+theme_classic(base_size=18)+ylab('')+xlab('externalizing b vs. c')+guides(y="none")+scale_x_continuous()
print(sum(abs(Grades$ext_permutedTstats_BvC[1:7500]>abs(Grades$ext_permutedTstats_BvC[7501]))))/7500


ggplot(Grades[1:7500,],aes(x=ext_permutedTstats_BvD))+geom_density(size=1.5)+geom_vline(xintercept = Grades$ext_permutedTstats_BvD[7501],size=2,color='#BC3754')+theme_classic(base_size=18)+ylab('')+xlab('externalizing b vs. failing')+guides(y="none")+scale_x_continuous()
print(sum(abs(Grades$ext_permutedTstats_BvD[1:7500]>abs(Grades$ext_permutedTstats_BvD[7501]))))/7500
...
masterdf$Pov_v2<-factor(masterdf$poverty, labels = pov_labels)
