...
MaxP=find_furthest_nonzero(PFits)
# load in 2k data
Fits=readRDS('~/Desktop/g_p/gpDerivBoots_asr2k.rds')

# remove instances where NA or 0 indicates that bootstrap was not populated


IFits = Fits[1:2000,(161:190)+437]
EFits = Fits[1:2000,(191:253)+437]
SomFits = Fits[1:2000,(254:273)+437]
AnxFits = Fits[1:2000,(274:304)+437]
ThoFits = Fits[1:2000,(305:322)+437]
WitFits = Fits[1:2000,(323:340)+437]
AttFits = Fits[1:2000,(341:371)+437]
RulFits = Fits[1:2000,(372:392)+437]
AggFits = Fits[1:2000,(393:437)+437]
IntrFits= Fits[1:2000,(438:447)+437]
...
MaxIntr=find_furthest_nonzero(IntrFits)
...
plot_bootstraps_par(IntrFits,10,'Intrusive',MaxIntr)
