...
plot_bootstraps(WitFits,18,'Withdrawn Depression',MaxWit,WitBc,WitC)
plot_bootstraps(AttFits,31,'Attention',MaxAtt,AttBc,AttC)
plot_bootstraps(RulFits,21,'Rule Breaking',MaxRul,RulBc,RulC)
