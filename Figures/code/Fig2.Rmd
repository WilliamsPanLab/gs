...
DevExpl1=readRDS('~/Desktop/g_p/F3-5DevExpl1.rds')
DevExpl2=readRDS('~/Desktop/g_p/F3-5DevExpl2.rds')
DevExpl3=readRDS('~/Desktop/g_p/F3-5DevExpl3.rds')
DevExpl4=readRDS('~/Desktop/g_p/F3-5DevExpl4.rds')
DevExpl5=readRDS('~/Desktop/g_p/F3-5DevExpl5.rds')
DevExpl6=readRDS('~/Desktop/g_p/F3-5DevExpl6.rds')
DevExpl7=readRDS('~/Desktop/g_p/F3-5DevExpl7.rds')
DevExpl8=readRDS('~/Desktop/g_p/F3-5DevExpl8.rds')
DevExpl=DevExpl1
DevExpl[1251:2500,]=DevExpl2[1251:2500,]
DevExpl[2501:3750,]=DevExpl3[2501:3750,]
DevExpl[3751:5000,]=DevExpl4[3751:5000,]
DevExpl[5001:6250,]=DevExpl5[5001:6250,]
# misalignment of indices for dev6 intentional
DevExpl[6251:7500,]=DevExpl6[7501:8750,]
DevExpl[7501:8750,]=DevExpl7[7501:8750,]
DevExpl[8751:10000,]=DevExpl8[8751:10000,]
...
custom_labels <- c(
  expression(italic(g)),
  "Grades",
  expression(italic(g) ~ "+ Parental" ~ italic(p)),
  expression("Grades + Parental" ~ italic(p))
)
# Create the boxplot - 1300 x 550 dimensions
ggplot(df_long, aes(x = variable, y = value)) +
  geom_boxplot(outlier.alpha = 0.1) +
  scale_x_discrete(labels = custom_labels) +
  scale_y_continuous(labels = function(x) sprintf("%.3f", x)) +
  ylab("Deviance Explained") + theme_minimal(base_size=28)

# now evaluate AIC differences
AIC1=readRDS('~/Desktop/g_p/F3-5AICdiff1.rds')
AIC2=readRDS('~/Desktop/g_p/F3-5AICdiff2.rds')
AIC3=readRDS('~/Desktop/g_p/F3-5AICdiff3.rds')
AIC4=readRDS('~/Desktop/g_p/F3-5AICdiff4.rds')
AIC5=readRDS('~/Desktop/g_p/F3-5AICdiff5.rds')
AIC6=readRDS('~/Desktop/g_p/F3-5AICdiff6.rds')
AIC7=readRDS('~/Desktop/g_p/F3-5AICdiff7.rds')
AIC8=readRDS('~/Desktop/g_p/F3-5AICdiff8.rds')
AIC=AIC1
AIC[1251:2500,]=AIC2[1251:2500,]
AIC[2501:3750,]=AIC3[2501:3750,]
AIC[3751:5000,]=AIC4[3751:5000,]
AIC[5001:6250,]=AIC5[5001:6250,]
# misalignment of indices for dev6 intentional
AIC[6251:7500,]=AIC6[7501:8750,]
AIC[7501:8750,]=AIC7[7501:8750,]
AIC[8751:10000,]=AIC8[8751:10000,]

df_long <- reshape2::melt(AIC)

column_names <- c(
  "AICdiff_g_v_grades",
  "AICdiff_g_v_gParentP",
  "AICdiff_g_v_gradesParentP",
  "AICdiff_grades_v_gParentP",
  "AICdiff_grades_v_gradesParentP",
  "AICdiff_gParentP_v_gradesParentP"
)

# Create the boxplot - 1300 x 550 dimensions
ggplot(df_long, aes(x = variable, y = value)) +
  geom_boxplot(outlier.alpha = 0.1) +
  scale_x_discrete(labels = column_names) +
  scale_y_continuous(labels = function(x) sprintf("%.3f", x)) +
  ylab("Cross-sectional Dev. Expl.") + theme_minimal(base_size=28)

# note there are no negative values: the first term has higher AIC across every single bootstrap
```

```{r}
# check out the grades differences
# now evaluate AIC differences
Grades1=readRDS('~/Desktop/g_p/F3-5Tstats1.rds')
Grades2=readRDS('~/Desktop/g_p/F3-5Tstats2.rds')
Grades3=readRDS('~/Desktop/g_p/F3-5Tstats3.rds')
Grades4=readRDS('~/Desktop/g_p/F3-5Tstats4.rds')
Grades5=readRDS('~/Desktop/g_p/F3-5Tstats5.rds')
Grades6=readRDS('~/Desktop/g_p/F3-5Tstats6.rds')
Grades7=readRDS('~/Desktop/g_p/F3-5Tstats7.rds')
Grades8=readRDS('~/Desktop/g_p/F3-5Tstats8.rds')
Grades=Grades1
Grades[1251:2500,]=Grades2[1251:2500,]
Grades[2501:3750,]=Grades3[2501:3750,]
Grades[3751:5000,]=Grades4[3751:5000,]
Grades[5001:6250,]=Grades5[5001:6250,]
Grades[6251:7500,]=Grades6[7501:8750,]
Grades[7501:8750,]=Grades7[7501:8750,]
Grades[8751:10000,]=Grades8[8751:10000,]

# plot observed vs expected - p factor
ggplot(Grades,aes(x=p_permutedTstats_AvB))+geom_density(size=1.5)+geom_vline(xintercept = Grades$p_permutedTstats_AvB[10001],size=2,color='#BC3754')+theme_classic(base_size=18)+ylab('')+xlab('p-factor a vs. b')+guides(y="none")+scale_x_continuous()
print(sum(abs(Grades$p_permutedTstats_AvB[1:10000]>abs(Grades$p_permutedTstats_AvB[10001]))))/10000

ggplot(Grades,aes(x=p_permutedTstats_AvC))+geom_density(size=1.5)+geom_vline(xintercept = Grades$p_permutedTstats_AvC[10001],size=2,color='#BC3754')+theme_classic(base_size=18)+ylab('')+xlab('p-factor a vs. c')+guides(y="none")+scale_x_continuous()
print(sum(abs(Grades$p_permutedTstats_AvC[1:10000]>abs(Grades$p_permutedTstats_AvC[10001]))))/10000


ggplot(Grades,aes(x=p_permutedTstats_AvD))+geom_density(size=1.5)+geom_vline(xintercept = Grades$p_permutedTstats_AvD[10001],size=2,color='#BC3754')+theme_classic(base_size=18)+ylab('')+xlab('p-factor a vs. failing')+guides(y="none")+scale_x_continuous()
print(sum(abs(Grades$p_permutedTstats_AvD[1:10000]>abs(Grades$p_permutedTstats_AvD[10001]))))/10000


ggplot(Grades,aes(x=p_permutedTstats_BvC))+geom_density(size=1.5)+geom_vline(xintercept = Grades$p_permutedTstats_BvC[10001],size=2,color='#BC3754')+theme_classic(base_size=18)+ylab('')+xlab('p-factor b vs. c')+guides(y="none")+scale_x_continuous()
print(sum(abs(Grades$p_permutedTstats_BvC[1:10000]>abs(Grades$p_permutedTstats_BvC[10001]))))/10000


ggplot(Grades,aes(x=p_permutedTstats_BvD))+geom_density(size=1.5)+geom_vline(xintercept = Grades$p_permutedTstats_BvD[10001],size=2,color='#BC3754')+theme_classic(base_size=18)+ylab('')+xlab('p-factor b vs. failing')+guides(y="none")+scale_x_continuous()
print(sum(abs(Grades$p_permutedTstats_BvD[1:10000]>abs(Grades$p_permutedTstats_BvD[10001]))))/10000


#ggplot(Grades,aes(x=p_permutedTstats_CvD))+geom_density(size=1.5)+geom_vline(xintercept = Grades$p_permutedTstats_CvD[7501],size=2,color='#BC3754')+theme_classic(base_size=18)+ylab('')+xlab('p-factor c vs. failing')+guides(y="none")+scale_x_continuous()

# plot observed vs expected - internalizing
ggplot(Grades,aes(x=int_permutedTstats_AvB))+geom_density(size=1.5)+geom_vline(xintercept = Grades$int_permutedTstats_AvB[10001],size=2,color='#BC3754')+theme_classic(base_size=18)+ylab('')+xlab('internalizing a vs. b')+guides(y="none")+scale_x_continuous()
print(sum(abs(Grades$int_permutedTstats_AvB[1:10000]>abs(Grades$int_permutedTstats_AvB[10001]))))/10000


ggplot(Grades,aes(x=int_permutedTstats_AvC))+geom_density(size=1.5)+geom_vline(xintercept = Grades$int_permutedTstats_AvC[10001],size=2,color='#BC3754')+theme_classic(base_size=18)+ylab('')+xlab('internalizing a vs. c')+guides(y="none")+scale_x_continuous()
print(sum(abs(Grades$int_permutedTstats_AvC[1:10000]>abs(Grades$int_permutedTstats_AvC[10001]))))/10000


ggplot(Grades,aes(x=int_permutedTstats_AvD))+geom_density(size=1.5)+geom_vline(xintercept = Grades$int_permutedTstats_AvD[10001],size=2,color='#BC3754')+theme_classic(base_size=18)+ylab('')+xlab('internalizing a vs. failing')+guides(y="none")+scale_x_continuous()
print(sum(abs(Grades$int_permutedTstats_AvD[1:10000]>abs(Grades$int_permutedTstats_AvD[10001]))))/10000


ggplot(Grades,aes(x=int_permutedTstats_BvC))+geom_density(size=1.5)+geom_vline(xintercept = Grades$int_permutedTstats_BvC[10001],size=2,color='#BC3754')+theme_classic(base_size=18)+ylab('')+xlab('internalizing b vs. c')+guides(y="none")+scale_x_continuous()
print(sum(abs(Grades$int_permutedTstats_BvC[1:10000]>abs(Grades$int_permutedTstats_BvC[10001]))))/10000


ggplot(Grades,aes(x=int_permutedTstats_BvD))+geom_density(size=1.5)+geom_vline(xintercept = Grades$int_permutedTstats_BvD[10001],size=2,color='#BC3754')+theme_classic(base_size=18)+ylab('')+xlab('internalizing b vs. failing')+guides(y="none")+scale_x_continuous()
print(sum(abs(Grades$int_permutedTstats_BvD[1:10000]>abs(Grades$int_permutedTstats_BvD[10001]))))/10000


#ggplot(Grades,aes(x=int_permutedTstats_CvD))+geom_density(size=1.5)+geom_vline(xintercept = Grades$int_permutedTstats_CvD[7501],size=2,color='#BC3754')+theme_classic(base_size=18)+ylab('')+xlab('internalizing c vs. failing')+guides(y="none")+scale_x_continuous()

# plot observed vs expected - externalizing
ggplot(Grades,aes(x=ext_permutedTstats_AvB))+geom_density(size=1.5)+geom_vline(xintercept = Grades$ext_permutedTstats_AvB[10001],size=2,color='#BC3754')+theme_classic(base_size=18)+ylab('')+xlab('externalizing a vs. b')+guides(y="none")+scale_x_continuous()
print(sum(abs(Grades$ext_permutedTstats_AvB[1:10000]>abs(Grades$ext_permutedTstats_AvB[10001]))))/10000


ggplot(Grades,aes(x=ext_permutedTstats_AvC))+geom_density(size=1.5)+geom_vline(xintercept = Grades$ext_permutedTstats_AvC[10001],size=2,color='#BC3754')+theme_classic(base_size=18)+ylab('')+xlab('externalizing a vs. c')+guides(y="none")+scale_x_continuous()
print(sum(abs(Grades$ext_permutedTstats_AvC[1:10000]>abs(Grades$ext_permutedTstats_AvC[10001]))))/10000


ggplot(Grades,aes(x=ext_permutedTstats_AvD))+geom_density(size=1.5)+geom_vline(xintercept = Grades$ext_permutedTstats_AvD[10001],size=2,color='#BC3754')+theme_classic(base_size=18)+ylab('')+xlab('externalizing a vs. failing')+guides(y="none")+scale_x_continuous()
print(sum(abs(Grades$ext_permutedTstats_AvD[1:10000]>abs(Grades$ext_permutedTstats_AvD[10001]))))/10000


ggplot(Grades,aes(x=ext_permutedTstats_BvC))+geom_density(size=1.5)+geom_vline(xintercept = Grades$ext_permutedTstats_BvC[10001],size=2,color='#BC3754')+theme_classic(base_size=18)+ylab('')+xlab('externalizing b vs. c')+guides(y="none")+scale_x_continuous()
print(sum(abs(Grades$ext_permutedTstats_BvC[1:10000]>abs(Grades$ext_permutedTstats_BvC[10001]))))/10000


ggplot(Grades,aes(x=ext_permutedTstats_BvD))+geom_density(size=1.5)+geom_vline(xintercept = Grades$ext_permutedTstats_BvD[10001],size=2,color='#BC3754')+theme_classic(base_size=18)+ylab('')+xlab('externalizing b vs. failing')+guides(y="none")+scale_x_continuous()
print(sum(abs(Grades$ext_permutedTstats_BvD[1:10000]>abs(Grades$ext_permutedTstats_BvD[10001]))))/10000
...
plotdf<-masterdf[,c('cbcl_scr_syn_totprob_r','cbcl_scr_syn_internal_r','cbcl_scr_syn_external_r','plotGrades')]
# p
ggplot(plotdf, aes(x = cbcl_scr_syn_totprob_r, y = plotGrades)) +
  geom_boxplot(fill="gray",alpha=.4) +
  labs(title = expression(italic(p)),
       x="",y = "Grades")+theme_minimal(base_size=25)+xlim(0,quantile(masterdf$cbcl_scr_syn_totprob_r,.999))+
      geom_vline(xintercept = Pbc, linetype = "dashed")+
      geom_vline(xintercept = Pc, linetype = "dashed")

# int
ggplot(plotdf, aes(x = cbcl_scr_syn_internal_r, y = plotGrades)) +
  geom_boxplot(fill="gray",alpha=.3) +
  labs(title = "Internalizing",
       x="",y = "Grades")+theme_minimal(base_size=25)+xlim(0,quantile(masterdf$cbcl_scr_syn_internal_r,.999))+
      geom_vline(xintercept = Ibc, linetype = "dashed")+
      geom_vline(xintercept = Ic, linetype = "dashed")

# ext
ggplot(plotdf, aes(x = cbcl_scr_syn_external_r, y = plotGrades)) +
  geom_boxplot(fill="gray",alpha=.3) +
  labs(title = "Externalizing",
       x="",y = "Grades")+theme_minimal(base_size=25)+xlim(0,quantile(masterdf$cbcl_scr_syn_external_r,.999))+
...
# poverty vs. no poverty grades
povdfBV=povdf[bv$Pov_v2=="Below",]
npovdfBV=povdf[bv$Pov_v2=="Above Poverty Line",]

povdfy2=povdf[y2$Pov_v2=="Below",]
npovdfy2=povdf[y2$Pov_v2=="Above Poverty Line",]

# models
grades_p_bv=gam(cbcl_scr_syn_totprob_r~Grades+s(interview_age),data=povdfBV)
summary(grades_p_bv)
grades_np_bv=gam(cbcl_scr_syn_totprob_r~Grades+s(interview_age),data=npovdfBV)
summary(grades_np_bv)
grades_p_y2=gam(cbcl_scr_syn_totprob_r~Grades+s(interview_age),data=povdfy2)
summary(grades_p_y2)
grades_np_y2=gam(cbcl_scr_syn_totprob_r~Grades+s(interview_age),data=npovdfy2)
summary(grades_np_y2)

# plots
plotdf<-masterdf[,c('cbcl_scr_syn_totprob_r','cbcl_scr_syn_internal_r','cbcl_scr_syn_external_r','plotGrades','Pov_v2')]
# p
ggplot(plotdf[plotdf$Pov_v2=="Below",], aes(x = cbcl_scr_syn_totprob_r, y = plotGrades)) +
  geom_boxplot(fill="gray",alpha=.4) +
  labs(title = expression(italic(p)),
       x="Below Poverty Line",y = "Grades")+theme_minimal(base_size=25)+xlim(0,quantile(masterdf$cbcl_scr_syn_totprob_r,.999))+
      geom_vline(xintercept = Pbc, linetype = "dashed")+
      geom_vline(xintercept = Pc, linetype = "dashed")

ggplot(plotdf[plotdf$Pov_v2=="Above Poverty Line",], aes(x = cbcl_scr_syn_totprob_r, y = plotGrades)) +
  geom_boxplot(fill="gray",alpha=.4) +
  labs(title = expression(italic(p)),
       x="Above Poverty Line",y = "Grades")+theme_minimal(base_size=25)+xlim(0,quantile(masterdf$cbcl_scr_syn_totprob_r,.999))+
      geom_vline(xintercept = Pbc, linetype = "dashed")+
      geom_vline(xintercept = Pc, linetype = "dashed")
...
```{r}
### MATCHED N FOR COMPARISON (FIGURE S10)
### poverty versus nonpoverty boots plot - CBCL

### re-merge the 5, update indices to pull values from
pNpFits1=readRDS('~/Downloads/gpFitBoots_nMatched_psuedoPov_cbclasr1.rds')
pNpFits2=readRDS('~/Downloads/gpFitBoots_nMatched_psuedoPov_cbclasr2.rds')
pNpFits3=readRDS('~/Downloads/gpFitBoots_nMatched_psuedoPov_cbclasr3.rds')
pNpFits4=readRDS('~/Downloads/gpFitBoots_nMatched_psuedoPov_cbclasr4.rds')
pNpFits5=readRDS('~/Downloads/gpFitBoots_nMatched_psuedoPov_cbclasr5.rds')
