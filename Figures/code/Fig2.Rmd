...
print(sum(diff1$asrPDiffPseudo>PovInt_AICDiff))
# asr int vs. null
...
print(sum(diff1$asrintDiffPseudo>PovInt_AICDiff))
# asr ext vs. null
...
print(sum(diff1$asrextDiffPseudo>PovInt_AICDiff))
# asr som vs. null
...
print(sum(diff1$asrsomDiffPseudo>PovInt_AICDiff))
# asr anxdep vs. null
...
print(sum(diff1$asranxDiffPseudo>PovInt_AICDiff))
# asr tho vs. null
...
print(sum(diff1$asrthoDiffPseudo>PovInt_AICDiff))
# asr withdep vs. null
...
print(sum(diff1$asrwitDiffPseudo>PovInt_AICDiff))
...
print(sum(diff1$asrattDiffPseudo>PovInt_AICDiff))
...
print(sum(diff1$asrrulDiffPseudo>PovInt_AICDiff))
# asr aggr vs. null
...
print(sum(diff1$asraggDiffPseudo>PovInt_AICDiff))
```   
...
# longitudinal
DevExpl_L1=readRDS('~/Desktop/g_p/F3-5DevExpl_longit1.rds')
DevExpl_L2=readRDS('~/Desktop/g_p/F3-5DevExpl_longit2.rds')
DevExpl_L3=readRDS('~/Desktop/g_p/F3-5DevExpl_longit3.rds')
DevExpl_L4=readRDS('~/Desktop/g_p/F3-5DevExpl_longit4.rds')
DevExpl_L5=readRDS('~/Desktop/g_p/F3-5DevExpl_longit5.rds')
DevExpl_L1_AIC=readRDS('~/Desktop/g_p/F3-5AICdiff_longit1.rds')
DevExpl_L2_AIC=readRDS('~/Desktop/g_p/F3-5AICdiff_longit2.rds')
DevExpl_L3_AIC=readRDS('~/Desktop/g_p/F3-5AICdiff_longit3.rds')
DevExpl_L4_AIC=readRDS('~/Desktop/g_p/F3-5AICdiff_longit4.rds')
DevExpl_L5_AIC=readRDS('~/Desktop/g_p/F3-5AICdiff_longit5.rds')
...
ggplot(df_long, aes(x = variable, y = value)) +
  ...
  xlab("Variables") +
  scale_x_discrete(labels = custom_labels) +
  ylab("Longitudinal Dev. Expl.") + theme_minimal(base_size=28)
```
