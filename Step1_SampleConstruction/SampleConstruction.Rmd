...
# preset x-axis names
x_labs=c("CBCL (both timepoints)", "Grades","Grades (both)","ASR (both)","ACS","Cognitive data (both)","One sibling per family","ABCC")
...
# preset x-axis names
x_labs=c("CBCL (both timepoints)", "Grades","Grades (both)","ASR (both)","ACS","Cognitive data (both)","One sibling per family","ABCC","Child SR")
