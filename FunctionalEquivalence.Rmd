...
ComparePlot<-ggplot(data=plotdf,aes(x=g,y=neurocog_pc1.bl))+geom_smooth(method='lm')+geom_point(alpha=.05)+theme_classic()
print(ComparePlot)
```
...
ComparePlot<-ggplot(data=plotdf,aes(x=parentPcount,y=parentP))+geom_smooth(method='lm')+geom_point(alpha=.05)+theme_classic()
print(ComparePlot)
```
