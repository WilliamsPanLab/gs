...
% load in subjs
topleveldir='/scratch/users/apines/derivatives/abcd-hcp-pipeline/sub-*'
direc=dir(topleveldir);
% deep gmless cifti for template
sname=subj;
parentfp=['/scratch/users/apines/derivatives/abcd-hcp-pipeline/' sname '/ses-baselineYear1Arm1/func/'];
...
missingDir=['/oak/stanford/groups/leanew1/users/apines/scripts/abcdImages/dl_logs/MissingDataReports/' sname];
mkdir(missingDir);
...
% and stack them onto an init coordinate-wise value
Oords=zeros(91282,1);
