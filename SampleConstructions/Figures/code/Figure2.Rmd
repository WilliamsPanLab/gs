...
#visreg(model,"cbcl_scr_syn_internal_r",gg=TRUE,ylab="g",xlab="Int",line.par=list(size=2,col='black'),alpha=0.05)+theme_minimal(base_size=2#5)+xlim(c(0,i999))+ylim(c(gLow999,g999))
