library(mgcv)
# load in data
masterdf=readRDS('/oak/stanford/groups/leanew1/users/apines/data/gp/mixedEfDf_TP2ForGrades.rds')
...
masterdf=masterdf[,c('cbcl_scr_syn_totprob_r','g','subjectkey','interview_age','sag_grade_type')]
...
for (b in 1:10000){
	...
	gpAge_full<-bam(g~s(cbcl_scr_syn_totprob_r)+s(interview_age)+sag_grade_type,data=bootSamp)
