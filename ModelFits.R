library(mgcv)
masterdf=readRDS('/oak/stanford/groups/leanew1/users/apines/mixedEfDf.rds')
...
# resilient version
rdata_file = file("/oak/stanford/groups/leanew1/users/apines/gpAge_te.rds", blocking = TRUE)
saveRDS(gpAge_te, file=rdata_file)
close(rdata_file)
rdata_file = file("/oak/stanford/groups/leanew1/users/apines/gpAge.rds", blocking = TRUE)
