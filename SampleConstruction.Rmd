...
#### MIGHT NEED TO RECODE THIS LINE FOR TEMP PREC DF: preBVdf$null<-as.numeric(yle1[,yle_No_PastYearcols_No_Goodbad_No_EvAff[i]])
# THINK THROUGH. DEPENDS ON IF YOU ARE GAUGING LIFETIME OCCURENCE AS CAUSAL FROM TP1->2, OR EVENT OCCURING B/W VISITS AS CAUSAL. MIGHT NEED BOTH.
