...
# for now exclude subjs who report yes at timepoint 1 but not 2: looks like about 152
...
for (i in 10:length(yle_No_PastYearcols_No_Goodbad_No_EvAff)){
  ...
  nonQSubjs=tmpdf$subjectkey[!questionableSubjs]
  #questionableSubjs=c(questionableSubjs,tmpdf$subjectkey[y1>y2])
}
  
# so if we use the events recorded that happened prior to the baseline visit, and those that are included at 2 year FUP how much missingess does that imbue?
