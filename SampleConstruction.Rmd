...
### can insert sidequest for g~bpca g functional equivalence if desired here
```
...
print(dim(masterdf))
#### ∆∆∆ Note this is without fancy adult P
```

```{r}
###########∆∆∆∆∆∆∆∆∆∆∆∆∆∆∆∆∆∆∆∆∆∆∆##############
# This chunk is a sidequest for demonstrating  #
# functional equivalence of total count and p in
# adults. Same for kids established elsehwere  #
###########∆∆∆∆∆∆∆∆∆∆∆∆∆∆∆∆∆∆∆∆∆∆∆##############
...
# polycormat
asrBV_qs_cormat=invisible(hetcor(asrBV_qs))
asr2_qs_cormat=invisible(hetcor(asr2_qs))
...
```{r}
###########∆∆∆∆∆∆∆∆∆∆∆∆∆∆∆∆∆∆∆∆∆∆∆##############
# This chunk wraps up the sidequest for 
# demonstrating functional equivalence of total 
# count and p in adults. Same for kids 
# established elsehwere,as same for g is
###########∆∆∆∆∆∆∆∆∆∆∆∆∆∆∆∆∆∆∆∆∆∆∆##############
...
###### ∆∆∆∆∆
#### CAUGHT RIGHT HERE THERE IS A 0 RESULTANT MERGE, LIKELY FROM MISPECIFIED VARIABLE
###### ∆∆∆∆∆∆

OutDF=merge(OutDF,asr,by=c('subjectkey','eventname','interview_age'))
### confirm tangentivity of sidequest
print(cor.test(OutDF2$parentP,OutDF2$parentPcount))
