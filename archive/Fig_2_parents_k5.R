...
for (b in 1:10000){
	...
	pgAge<-bam(g~s(cbcl_scr_syn_totprob_r,k=4)+s(interview_age)+s(parentPcount,k=4),data=bootSamp)
	intgAge<-bam(g~s(cbcl_scr_syn_internal_r,k=4)+s(interview_age)+s(ASRInt,k=4),data=bootSamp)
	extgAge<-bam(g~s(cbcl_scr_syn_external_r,k=4)+s(interview_age)+s(ASRExt,k=4),data=bootSamp)
	somgAge<-bam(g~s(cbcl_scr_syn_somatic_r,k=4)+s(interview_age)+s(ASR_somatic,k=4),data=bootSamp)
	anxgAge<-bam(g~s(cbcl_scr_syn_anxdep_r,k=4)+s(interview_age)+s(ASR_anxdep,k=4),data=bootSamp)
	thogAge<-bam(g~s(cbcl_scr_syn_thought_r,k=4)+s(interview_age)+s(ASR_thought,k=4),data=bootSamp)
	witgAge<-bam(g~s(cbcl_scr_syn_withdep_r,k=4)+s(interview_age)+s(ASR_withdep,k=4),data=bootSamp)
	attgAge<-bam(g~s(cbcl_scr_syn_attention_r,k=4)+s(interview_age)+s(ASR_attention,k=4),data=bootSamp)
	rulgAge<-bam(g~s(cbcl_scr_syn_rulebreak_r,k=4)+s(interview_age)+s(ASR_rulebreak,k=4),data=bootSamp)
	agggAge<-bam(g~s(cbcl_scr_syn_aggressive_r,k=4)+s(interview_age)+s(ASR_aggressive,k=4),data=bootSamp)
	#### ASR
	asrpgAge<-bam(g~s(parentPcount,k=4)+s(interview_age),data=bootSamp)
	asrintgAge<-bam(g~s(ASRInt,k=4)+s(interview_age),data=bootSamp)
	asrextgAge<-bam(g~s(ASRExt,k=4)+s(interview_age),data=bootSamp)
	asrsomgAge<-bam(g~s(ASR_somatic,k=4)+s(interview_age),data=bootSamp)
	asranxgAge<-bam(g~s(ASR_anxdep,k=4)+s(interview_age),data=bootSamp)
	asrthogAge<-bam(g~s(ASR_thought,k=4)+s(interview_age),data=bootSamp)
	asrwitgAge<-bam(g~s(ASR_withdep,k=4)+s(interview_age),data=bootSamp)
	asrattgAge<-bam(g~s(ASR_attention,k=4)+s(interview_age),data=bootSamp)
	asrrulgAge<-bam(g~s(ASR_rulebreak,k=4)+s(interview_age),data=bootSamp)
	asragggAge<-bam(g~s(ASR_aggressive,k=4)+s(interview_age),data=bootSamp)
...
saveRDS(outdf,'/oak/stanford/groups/leanew1/users/apines/data/gp/gpBoots_asr_k4.rds')
...
saveRDS(outdf,'/oak/stanford/groups/leanew1/users/apines/data/gp/gpDerivBoots_asr_k4.rds')
...
saveRDS(outdf,'/oak/stanford/groups/leanew1/users/apines/data/gp/gpFitBoots_asr_k4.rds')
