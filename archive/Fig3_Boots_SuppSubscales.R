...
for (b in 1:10000){
	...
	IntgAge_seg<-bam(g~s(cbcl_scr_syn_internal_r,by=seg,k=4)+s(cbcl_scr_syn_internal_r,k=4)+seg+s(interview_age,k=4),data=bootSamp)
	ExtgAge_seg<-bam(g~s(cbcl_scr_syn_external_r,by=seg,k=4)+s(cbcl_scr_syn_external_r,k=4)+seg+s(interview_age,k=4),data=bootSamp)
	SomgAge_seg<-bam(g~s(cbcl_scr_syn_somatic_r,by=seg,k=4)+s(cbcl_scr_syn_somatic_r,k=4)+seg+s(interview_age,k=4),data=bootSamp)
	AnxgAge_seg<-bam(g~s(cbcl_scr_syn_anxdep_r,by=seg,k=4)+s(cbcl_scr_syn_anxdep_r,k=4)+seg+s(interview_age,k=4),data=bootSamp)
	ThogAge_seg<-bam(g~s(cbcl_scr_syn_thought_r,by=seg,k=4)+s(cbcl_scr_syn_thought_r,k=4)+seg+s(interview_age,k=4),data=bootSamp)
	WitDepgAge_seg<-bam(g~s(cbcl_scr_syn_withdep_r,by=seg,k=4)+s(cbcl_scr_syn_withdep_r,k=4)+seg+s(interview_age,k=4),data=bootSamp)
	SocgAge_seg<-bam(g~s(cbcl_scr_syn_social_r,by=seg,k=4)+s(cbcl_scr_syn_social_r,k=4)+seg+s(interview_age,k=4),data=bootSamp)
	AttgAge_seg<-bam(g~s(cbcl_scr_syn_attention_r,by=seg,k=4)+s(cbcl_scr_syn_attention_r,k=4)+seg+s(interview_age,k=4),data=bootSamp)
	RulgAge_seg<-bam(g~s(cbcl_scr_syn_rulebreak_r,by=seg,k=4)+s(cbcl_scr_syn_rulebreak_r,k=4)+seg+s(interview_age,k=4),data=bootSamp)
	AgggAge_seg<-bam(g~s(cbcl_scr_syn_aggressive_r,by=seg,k=4)+s(cbcl_scr_syn_aggressive_r,k=4)+seg+s(interview_age,k=4),data=bootSamp)
	IntgAge_pov<-bam(g~s(cbcl_scr_syn_internal_r,by=poverty,k=4)+s(cbcl_scr_syn_internal_r,k=4)+poverty+s(interview_age,k=4),data=bootSamp)
	ExtgAge_pov<-bam(g~s(cbcl_scr_syn_external_r,by=poverty,k=4)+s(cbcl_scr_syn_external_r,k=4)+poverty+s(interview_age,k=4),data=bootSamp)
	SomgAge_pov<-bam(g~s(cbcl_scr_syn_somatic_r,by=poverty,k=4)+s(cbcl_scr_syn_somatic_r,k=4)+poverty+s(interview_age,k=4),data=bootSamp)
	AnxgAge_pov<-bam(g~s(cbcl_scr_syn_anxdep_r,by=poverty,k=4)+s(cbcl_scr_syn_anxdep_r,k=4)+poverty+s(interview_age,k=4),data=bootSamp)
	ThogAge_pov<-bam(g~s(cbcl_scr_syn_thought_r,by=poverty,k=4)+s(cbcl_scr_syn_thought_r,k=4)+poverty+s(interview_age,k=4),data=bootSamp)
	WitDepgAge_pov<-bam(g~s(cbcl_scr_syn_withdep_r,by=poverty,k=4)+s(cbcl_scr_syn_withdep_r,k=4)+poverty+s(interview_age,k=4),data=bootSamp)
	SocgAge_pov<-bam(g~s(cbcl_scr_syn_social_r,by=poverty,k=4)+s(cbcl_scr_syn_social_r,k=4)+poverty+s(interview_age,k=4),data=bootSamp)
	AttgAge_pov<-bam(g~s(cbcl_scr_syn_attention_r,by=poverty,k=4)+s(cbcl_scr_syn_attention_r,k=4)+poverty+s(interview_age,k=4),data=bootSamp)
	RulgAge_pov<-bam(g~s(cbcl_scr_syn_rulebreak_r,by=poverty,k=4)+s(cbcl_scr_syn_rulebreak_r,k=4)+poverty+s(interview_age,k=4),data=bootSamp)
	AgggAge_pov<-bam(g~s(cbcl_scr_syn_aggressive_r,by=poverty,k=4)+s(cbcl_scr_syn_aggressive_r,k=4)+poverty+s(interview_age,k=4),data=bootSamp)
