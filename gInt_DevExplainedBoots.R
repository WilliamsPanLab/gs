...
i_devExplained_full=rep(0,10000)
i_devExplained_NoGrades=rep(0,10000)
i_devExplained_NoG=rep(0,10000)
...
masterdf=masterdf[,c('cbcl_scr_syn_internal_r','g','subjectkey','interview_age','Grades')]
...
outdf=data.frame(devExplained_full,devExplained_NoGrades,devExplained_NoTot,i_devExplained_full,i_devExplained_NoGrades,i_devExplained_NoG,grades_devExplained_full,grades_devExplained_noG,grades_devExplained_noTot)
