...
for (b in 1:3000){
	...
	# get median absolute error
	MAE_n_weight[b]=median(abs((exp(predict_n_weight)-1)-(exp(bootSampt$cbcl_scr_syn_external_r)-1)))
	...
	# get median absolute error
	MAE_n_waist[b]=median(abs((exp(predict_n_waist)-1)-(exp(bootSampt$cbcl_scr_syn_external_r)-1)))
	...
	# get median absolute error
	MAE_n_height[b]=median(abs((exp(predict_n_height)-1)-(exp(bootSampt$cbcl_scr_syn_external_r)-1)))
	# get heldout median absolute error
	...
	# get median absolute error
	MAE_n_BMI[b]=median(abs((exp(predict_n_BMI)-1)-(exp(bootSampt$cbcl_scr_syn_external_r)-1)))
	# get heldout median absolute error	
