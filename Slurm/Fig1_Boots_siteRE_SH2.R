...
# load in data
masterdf=readRDS('/oak/stanford/groups/leanew1/users/apines/data/gp/gp_SH2_masterdf.rds')
...
saveRDS(outdf,'/oak/stanford/groups/leanew1/users/apines/data/gp/gpBoots_sRE_SH2.rds')
outdf=data.frame(pDeriv,intDeriv,extDeriv,somDeriv,anxDeriv,thoDeriv,witDeriv,socDeriv,attDeriv,rulDeriv,aggDeriv)
saveRDS(outdf,'/oak/stanford/groups/leanew1/users/apines/data/gp/gpDerivBoots_sRE_SH2.rds')
outdf=data.frame(pFit,intFit,extFit,somFit,anxFit,thoFit,witFit,socFit,attFit,rulFit,aggFit)
saveRDS(outdf,'/oak/stanford/groups/leanew1/users/apines/data/gp/gpFitBoots_sRE_SH2.rds')
