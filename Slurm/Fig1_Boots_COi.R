...
# load in data
masterdf=readRDS('/oak/stanford/groups/leanew1/users/apines/data/gp/gp_COi_masterdf.rds')
# FYI
...
saveRDS(outdf,'/oak/stanford/groups/leanew1/users/apines/data/gp/gp_COi_Boots.rds')
