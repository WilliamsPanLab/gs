...
for (b in 1:3000){
	...
	sumSq_heldout_full[b]=sum(((exp(predictFullHeldOut)-1)-(exp(heldOut$cbcl_scr_syn_external_r)-1))^2)
	# get AIC
	...
	# get MAE
	MAE_full[b]=median(abs((exp(predictFull)-1)-(exp(bootSamp$cbcl_scr_syn_external_r)-1)))
	# get MAE held out
	...
	sumSq_heldout_n_died[b]=sum(((exp(predict_n_diedHeldOut)-1)-(exp(heldOut$cbcl_scr_syn_external_r)-1))^2)
	# get AIC
	...
	# get MAE
	MAE_n_died[b]=median(abs((exp(predict_n_died)-1)-(exp(bootSamp$cbcl_scr_syn_external_r)-1)))
	# get hMAE
	...
	sumSq_heldout_n_injured[b]=sum(((exp(predict_n_injuredHeldOut)-1)-(exp(heldOut$cbcl_scr_syn_external_r)-1))^2)
	# get AIC
	...
	# get MAE
	MAE_n_injured[b]=median(abs((exp(predict_n_injured)-1)-(exp(bootSamp$cbcl_scr_syn_external_r)-1)))
	# get hMAE
	...
	sumSq_heldout_n_crime[b]=sum(((exp(predict_n_crimeHeldOut)-1)-(exp(heldOut$cbcl_scr_syn_external_r)-1))^2)
	# get AIC
	...
	# get MAE
	MAE_n_crime[b]=median(abs((exp(predict_n_crime)-1)-(exp(bootSamp$cbcl_scr_syn_external_r)-1)))
	# get hMAE
	...
	sumSq_heldout_n_friend[b]=sum(((exp(predict_n_friendHeldOut)-1)-(exp(heldOut$cbcl_scr_syn_external_r)-1))^2)
	# get AIC
	...
	# get MAE
	MAE_n_friend[b]=median(abs((exp(predict_n_friend)-1)-(exp(bootSamp$cbcl_scr_syn_external_r)-1)))
	# get hMAE
	...
	sumSq_heldout_n_friend_injur[b]=sum(((exp(predict_n_friend_injuredHeldOut)-1)-(exp(heldOut$cbcl_scr_syn_external_r)-1))^2)
	# get AIC
	...
	# get MAE
	MAE_n_friend_injur[b]=median(abs((exp(predict_n_friend_injured)-1)-(exp(bootSamp$cbcl_scr_syn_external_r)-1)))
	# get hMAE
	...
	sumSq_heldout_n_arrest[b]=sum(((exp(predict_n_arrestHeldOut)-1)-(exp(heldOut$cbcl_scr_syn_external_r)-1))^2)
	# get AIC
	...
	# get MAE
	MAE_n_arrest[b]=median(abs((exp(predict_n_arrest)-1)-(exp(bootSamp$cbcl_scr_syn_external_r)-1)))
	# get hMAE
	...
	sumSq_heldout_n_friend_died[b]=sum(((exp(predict_n_friend_diedHeldOut)-1)-(exp(heldOut$cbcl_scr_syn_external_r)-1))^2)
	# get AIC
	...
	# get MAE
	MAE_n_friend_died[b]=median(abs((exp(predict_n_friend_died)-1)-(exp(bootSamp$cbcl_scr_syn_external_r)-1)))
	# get hMAE
	...
	sumSq_heldout_n_mh[b]=sum(((exp(predict_n_mhHeldOut)-1)-(exp(heldOut$cbcl_scr_syn_external_r)-1))^2)
	# get AIC
	...
	# get MAE
	MAE_n_mh[b]=median(abs((exp(predict_n_mh)-1)-(exp(bootSamp$cbcl_scr_syn_external_r)-1)))
	# get hMAE
	...
	sumSq_heldout_n_sib[b]=sum(((exp(predict_n_sibHeldOut)-1)-(exp(heldOut$cbcl_scr_syn_external_r)-1))^2)
	# get AIC
	...
	# get MAE
	MAE_n_sib[b]=median(abs((exp(predict_n_sib)-1)-(exp(bootSamp$cbcl_scr_syn_external_r)-1)))
	# get hMAE
	...
	sumSq_heldout_n_victim[b]=sum(((exp(predict_n_victimHeldOut)-1)-(exp(heldOut$cbcl_scr_syn_external_r)-1))^2)
	# get AIC
	...
	# get MAE
	MAE_n_victim[b]=median(abs((exp(predict_n_victim)-1)-(exp(bootSamp$cbcl_scr_syn_external_r)-1)))
	# get hMAE
	...
	sumSq_heldout_n_separ[b]=sum(((exp(predict_n_separHeldOut)-1)-(exp(heldOut$cbcl_scr_syn_external_r)-1))^2)
	# get AIC
	...
	# get MAE
	MAE_n_separ[b]=median(abs((exp(predict_n_separ)-1)-(exp(bootSamp$cbcl_scr_syn_external_r)-1)))
	# get hMAE
	...
	sumSq_heldout_n_law[b]=sum(((exp(predict_n_lawHeldOut)-1)-(exp(heldOut$cbcl_scr_syn_external_r)-1))^2)
	# get AIC
	...
	# get MAE
	MAE_n_law[b]=median(abs((exp(predict_n_law)-1)-(exp(bootSamp$cbcl_scr_syn_external_r)-1)))
	# get hMAE
	...
	sumSq_heldout_n_school[b]=sum(((exp(predict_n_schoolHeldOut)-1)-(exp(heldOut$cbcl_scr_syn_external_r)-1))^2)
	# get AIC
	...
	# get MAE
	MAE_n_school[b]=median(abs((exp(predict_n_school)-1)-(exp(bootSamp$cbcl_scr_syn_external_r)-1)))
	# get hMAE
	...
	sumSq_heldout_n_move[b]=sum(((exp(predict_n_moveHeldOut)-1)-(exp(heldOut$cbcl_scr_syn_external_r)-1))^2)
	# get AIC
	...
	# get MAE
	MAE_n_move[b]=median(abs((exp(predict_n_move)-1)-(exp(bootSamp$cbcl_scr_syn_external_r)-1)))
	# get hMAE
	...
	sumSq_heldout_n_jail[b]=sum(((exp(predict_n_jailHeldOut)-1)-(exp(heldOut$cbcl_scr_syn_external_r)-1))^2)
	# get AIC
	...
	# get MAE
	MAE_n_jail[b]=median(abs((exp(predict_n_jail)-1)-(exp(bootSamp$cbcl_scr_syn_external_r)-1)))
	# get hMAE
	...
	sumSq_heldout_n_step[b]=sum(((exp(predict_n_stepHeldOut)-1)-(exp(heldOut$cbcl_scr_syn_external_r)-1))^2)
	# get AIC
	...
	# get MAE
	MAE_n_step[b]=median(abs((exp(predict_n_step)-1)-(exp(bootSamp$cbcl_scr_syn_external_r)-1)))
	# get hMAE
	...
	sumSq_heldout_n_new_job[b]=sum(((exp(predict_n_jobHeldOut)-1)-(exp(heldOut$cbcl_scr_syn_external_r)-1))^2)
	# get AIC
	...
	# get MAE
	MAE_n_new_job[b]=median(abs((exp(predict_n_job)-1)-(exp(bootSamp$cbcl_scr_syn_external_r)-1)))
	# get hMAE
	...
	sumSq_heldout_n_new_sib[b]=sum(((exp(predict_n_new_sibHeldOut)-1)-(exp(heldOut$cbcl_scr_syn_external_r)-1))^2)
	# get AIC
	...
	# get MAE
	MAE_n_new_sib[b]=median(abs((exp(predict_n_new_sib)-1)-(exp(bootSamp$cbcl_scr_syn_external_r)-1)))
	# get hMAE
	...
	sumSq_heldout_n_g[b]=sum(((exp(predict_n_gHeldOut)-1)-(exp(heldOut$cbcl_scr_syn_external_r)-1))^2)
	# get AIC
	...
	# get MAE
	MAE_n_g[b]=median(abs((exp(predict_n_g)-1)-(exp(bootSamp$cbcl_scr_syn_external_r)-1)))
	# get hMAE
	...
	sumSq_heldout_n_interview_age[b]=sum(((exp(predict_n_ageHeldOut)-1)-(exp(heldOut$cbcl_scr_syn_external_r)-1))^2)
	# get AIC
	...
	# get MAE
	MAE_n_interview_age[b]=median(abs((exp(predict_n_age)-1)-(exp(bootSamp$cbcl_scr_syn_external_r)-1)))
	# get hMAE
	...
	sumSq_heldout_n_Grades[b]=sum(((exp(predict_n_gradesHeldOut)-1)-(exp(heldOut$cbcl_scr_syn_external_r)-1))^2)
	# get AIC
	...
	# get MAE
	MAE_n_Grades[b]=median(abs((exp(predict_n_grades)-1)-(exp(bootSamp$cbcl_scr_syn_external_r)-1)))
	# get hMAE
	...
	sumSq_heldout_n_parentPcount[b]=sum(((exp(predict_n_parentPcountHeldOut)-1)-(exp(heldOut$cbcl_scr_syn_external_r)-1))^2)
	# get AIC
	...
	# get MAE
	MAE_n_parentPcount[b]=median(abs((exp(predict_n_parentPcount)-1)-(exp(bootSamp$cbcl_scr_syn_external_r)-1)))
	# get hMAE
	hMAE_n_parentPcount[b]=median(abs((exp(predict_n_parentPcountHeldOut)-1)-(exp(heldOut$cbcl_scr_syn_external_r)-1)))
	...
	sumSq_n_income[b]=sum(((exp(predict_n_income)-1)-(exp(bootSamp$cbcl_scr_syn_external_r)-1))^2)
	# predict held out to get sum of squares on held out
	predict_n_incomeHeldOut=predict.bam(Model_n_income,heldOut)
	sumSq_heldout_n_income[b]=sum(((exp(predict_n_incomeHeldOut)-1)-(exp(heldOut$cbcl_scr_syn_external_r)-1))^2)
	# get AIC
	...
	# get MAE
	MAE_n_income[b]=median(abs((exp(predict_n_income)-1)-(exp(bootSamp$cbcl_scr_syn_external_r)-1)))
	# get hMAE
	...
	sumSq_heldout_n_parental_education[b]=sum(((exp(predict_n_parental_educationHeldOut)-1)-(exp(heldOut$cbcl_scr_syn_external_r)-1))^2)
	# get AIC
	...
	# get MAE
	MAE_n_parental_education[b]=median(abs((exp(predict_n_parental_education)-1)-(exp(bootSamp$cbcl_scr_syn_external_r)-1)))
	# get hMAE
	...
	sumSq_heldout_n_sex[b]=sum(((exp(predict_n_sexHeldOut)-1)-(exp(heldOut$cbcl_scr_syn_external_r)-1))^2)
	# get AIC
	...
	# get MAE
	MAE_n_sex[b]=median(abs((exp(predict_n_sex)-1)-(exp(bootSamp$cbcl_scr_syn_external_r)-1)))
	# get hMAE
	...
	sumSq_heldout_n_race_ethnicity[b]<-sum(((exp(predict_n_race_ethnicityHeldout)-1)-(exp(heldOut$cbcl_scr_syn_external_r)-1))^2)
	# get AIC
	...
	# get MAE
	MAE_n_race_ethnicity[b]=median(abs((exp(predict_n_race_ethnicity)-1)-(exp(bootSamp$cbcl_scr_syn_external_r)-1)))
	# get hMAE
	...
	# predict to get sum of squares
        ...
        sumSq_heldout_n_weight[b]=sum(((exp(predict_n_weightHeldOut)-1)-(exp(heldOut$cbcl_scr_syn_external_r)-1))^2)
        # get AIC
	...
	# get MAE
	MAE_n_weight[b]=median(abs((exp(predict_n_weight)-1)-(exp(bootSamp$cbcl_scr_syn_external_r)-1)))
	# get hMAE
	...
	# predict to get sum of squares
        ...
        sumSq_heldout_n_waist[b]=sum(((exp(predict_n_waistHeldOut)-1)-(exp(heldOut$cbcl_scr_syn_external_r)-1))^2)
        # get AIC
	...
	# get MAE
	MAE_n_waist[b]=median(abs((exp(predict_n_waist)-1)-(exp(bootSamp$cbcl_scr_syn_external_r)-1)))
	# get hMAE
	...
	# predict to get sum of squares
        ...
        sumSq_heldout_n_height[b]=sum(((exp(predict_n_heightHeldOut)-1)-(exp(heldOut$cbcl_scr_syn_external_r)-1))^2)
        # get AIC
	...
	# get MAE
	MAE_n_height[b]=median(abs((exp(predict_n_height)-1)-(exp(bootSamp$cbcl_scr_syn_external_r)-1)))
	# get hMAE
	...
	# predict to get sum of squares
        ...
        sumSq_heldout_n_BMI[b]=sum(((exp(predict_n_BMIHeldOut)-1)-(exp(heldOut$cbcl_scr_syn_external_r)-1))^2)
        # get AIC
	...
	# get MAE
	MAE_n_BMI[b]=median(abs((exp(predict_n_BMI)-1)-(exp(bootSamp$cbcl_scr_syn_external_r)-1)))
	# get hMAE
	hMAE_n_BMI[b]=median(abs((exp(predict_n_BMIHeldOut)-1)-(exp(heldOut$cbcl_scr_syn_external_r)-1)))
