...
saveRDS(outdf,'/oak/stanford/groups/leanew1/users/apines/data/gp/F3_gpFandAIC_1k.rds')
# save out fits
...
saveRDS(outdf,'/oak/stanford/groups/leanew1/users/apines/data/gp/F3_gpFits_1k.rds')
...
saveRDS(outdf,'/oak/stanford/groups/leanew1/users/apines/data/gp/F3_gpDerivs_1k.rds')
