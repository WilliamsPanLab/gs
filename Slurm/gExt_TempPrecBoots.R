...
for (b in 1:5000){
	...
	sumSq_heldout_full[b]=sum((predictFullHeldOut-heldOut$cbcl_scr_syn_external_r.y)^2)
	# get AIC
	...
	sumSq_heldout_n_died[b]=sum((predict_n_diedHeldOut-heldOut$cbcl_scr_syn_external_r.y)^2)
	# get AIC
	...
	sumSq_heldout_n_injured[b]=sum((predict_n_injuredHeldOut-heldOut$cbcl_scr_syn_external_r.y)^2)
	# get AIC
	...
	sumSq_heldout_n_crime[b]=sum((predict_n_crimeHeldOut-heldOut$cbcl_scr_syn_external_r.y)^2)
	# get AIC
	...
	sumSq_heldout_n_friend[b]=sum((predict_n_friendHeldOut-heldOut$cbcl_scr_syn_external_r.y)^2)
	# get AIC
	...
	sumSq_heldout_n_friend_injur[b]=sum((predict_n_friend_injuredHeldOut-heldOut$cbcl_scr_syn_external_r.y)^2)
	# get AIC
	...
	sumSq_heldout_n_arrest[b]=sum((predict_n_arrestHeldOut-heldOut$cbcl_scr_syn_external_r.y)^2)
	# get AIC
	...
	sumSq_heldout_n_friend_died[b]=sum((predict_n_friend_diedHeldOut-heldOut$cbcl_scr_syn_external_r.y)^2)
	# get AIC
	...
	sumSq_heldout_n_mh[b]=sum((predict_n_mhHeldOut-heldOut$cbcl_scr_syn_external_r.y)^2)
	# get AIC
	...
	sumSq_heldout_n_sib[b]=sum((predict_n_sibHeldOut-heldOut$cbcl_scr_syn_external_r.y)^2)
	# get AIC
	...
	sumSq_heldout_n_victim[b]=sum((predict_n_victimHeldOut-heldOut$cbcl_scr_syn_external_r.y)^2)
	# get AIC
	...
	sumSq_heldout_n_separ[b]=sum((predict_n_separHeldOut-heldOut$cbcl_scr_syn_external_r.y)^2)
	# get AIC
	...
	sumSq_heldout_n_law[b]=sum((predict_n_lawHeldOut-heldOut$cbcl_scr_syn_external_r.y)^2)
	# get AIC
	...
	sumSq_heldout_n_school[b]=sum((predict_n_schoolHeldOut-heldOut$cbcl_scr_syn_external_r.y)^2)
	# get AIC
	...
	sumSq_heldout_n_move[b]=sum((predict_n_moveHeldOut-heldOut$cbcl_scr_syn_external_r.y)^2)
	# get AIC
	...
	sumSq_heldout_n_jail[b]=sum((predict_n_jailHeldOut-heldOut$cbcl_scr_syn_external_r.y)^2)
	# get AIC
	...
	### step
	Model_n_step<-bam(cbcl_scr_syn_external_r.y~cbcl_scr_syn_external_r.x+ple_died_y.x+ple_injured_y.x+ple_crime_y.x+ple_friend_y.x+ple_friend_injur_y.x+ple_arrest_y.x+ple_friend_died_y.x+ple_mh_y.x+ple_sib_y.x+ple_victim_y.x+ple_separ_y.x+ple_law_y.x+ple_school_y.x+ple_move_y.x+ple_jail_y.x+ple_new_job_y.x+ple_new_sib_y.x+s(g.x,k=4)+s(age.x,k=4)+s(Grades.x,k=4)+s(parentPcount.x,k=4)+s(income.x,k=4)+s(parental_education.x,k=4)+sex.x.x+race_ethnicity.x,data=bootSamp,family=nb())
	# predict to get sum of squares
	...
	sumSq_heldout_n_step[b]=sum((predict_n_stepHeldOut-heldOut$cbcl_scr_syn_external_r.y)^2)
	# get AIC
	...
	sumSq_heldout_n_new_job[b]=sum((predict_n_jobHeldOut-heldOut$cbcl_scr_syn_external_r.y)^2)
	# get AIC
	...
	sumSq_heldout_n_new_sib[b]=sum((predict_n_new_sibHeldOut-heldOut$cbcl_scr_syn_external_r.y)^2)
	# get AIC
	...
	sumSq_heldout_n_g[b]=sum((predict_n_gHeldOut-heldOut$cbcl_scr_syn_external_r.y)^2)
	# get AIC
	...
	sumSq_heldout_n_age[b]=sum((predict_n_ageHeldOut-heldOut$cbcl_scr_syn_external_r.y)^2)
	# get AIC
	...
	sumSq_heldout_n_Grades[b]=sum((predict_n_gradesHeldOut-heldOut$cbcl_scr_syn_external_r.y)^2)
	# get AIC
	...
	sumSq_heldout_n_parentPcount[b]=sum((predict_n_parentPcountHeldOut-heldOut$cbcl_scr_syn_external_r.y)^2)
	# get AIC
	...
	sumSq_heldout_n_income[b]=sum((predict_n_incomeHeldOut-heldOut$cbcl_scr_syn_external_r.y)^2)
	# get AIC
	...
	sumSq_heldout_n_parental_education[b]=sum((predict_n_parental_educationHeldOut-heldOut$cbcl_scr_syn_external_r.y)^2)
	# get AIC
	...
	sumSq_heldout_n_sex[b]=sum((predict_n_sexHeldOut-heldOut$cbcl_scr_syn_external_r.y)^2)
	# get AIC
	...
	sumSq_heldout_n_race_ethnicity[b]<-sum((predict_n_race_ethnicityHeldout-heldOut$cbcl_scr_syn_external_r.y)^2)
	# get AIC
