...
for (b in 1:5000){
	...
	sumSq_heldout_full[b]=sum(((exp(predictFullHeldOut)-1)-(exp(heldOut$cbcl_scr_syn_internal_r.y)-1))^2)
	# get AIC
	...
	sumSq_heldout_n_died[b]=sum(((exp(predict_n_diedHeldOut)-1)-(exp(heldOut$cbcl_scr_syn_internal_r.y)-1))^2)
	# get AIC
	...
	sumSq_heldout_n_injured[b]=sum(((exp(predict_n_injuredHeldOut)-1)-(exp(heldOut$cbcl_scr_syn_internal_r.y)-1))^2)
	# get AIC
	...
	sumSq_heldout_n_crime[b]=sum(((exp(predict_n_crimeHeldOut)-1)-(exp(heldOut$cbcl_scr_syn_internal_r.y)-1))^2)
	# get AIC
	...
	sumSq_heldout_n_friend[b]=sum(((exp(predict_n_friendHeldOut)-1)-(exp(heldOut$cbcl_scr_syn_internal_r.y)-1))^2)
	# get AIC
	...
	sumSq_heldout_n_friend_injur[b]=sum(((exp(predict_n_friend_injuredHeldOut)-1)-(exp(heldOut$cbcl_scr_syn_internal_r.y)-1))^2)
	# get AIC
	...
	sumSq_heldout_n_arrest[b]=sum(((exp(predict_n_arrestHeldOut)-1)-(exp(heldOut$cbcl_scr_syn_internal_r.y)-1))^2)
	# get AIC
	...
	sumSq_heldout_n_friend_died[b]=sum(((exp(predict_n_friend_diedHeldOut)-1)-(exp(heldOut$cbcl_scr_syn_internal_r.y)-1))^2)
	# get AIC
	...
	sumSq_heldout_n_mh[b]=sum(((exp(predict_n_mhHeldOut)-1)-(exp(heldOut$cbcl_scr_syn_internal_r.y)-1))^2)
	# get AIC
	...
	sumSq_heldout_n_sib[b]=sum(((exp(predict_n_sibHeldOut)-1)-(exp(heldOut$cbcl_scr_syn_internal_r.y)-1))^2)
	# get AIC
	...
	sumSq_heldout_n_victim[b]=sum(((exp(predict_n_victimHeldOut)-1)-(exp(heldOut$cbcl_scr_syn_internal_r.y)-1))^2)
	# get AIC
	...
	sumSq_heldout_n_separ[b]=sum(((exp(predict_n_separHeldOut)-1)-(exp(heldOut$cbcl_scr_syn_internal_r.y)-1))^2)
	# get AIC
	...
	sumSq_heldout_n_law[b]=sum(((exp(predict_n_lawHeldOut)-1)-(exp(heldOut$cbcl_scr_syn_internal_r.y)-1))^2)
	# get AIC
	...
	sumSq_heldout_n_school[b]=sum(((exp(predict_n_schoolHeldOut)-1)-(exp(heldOut$cbcl_scr_syn_internal_r.y)-1))^2)
	# get AIC
	...
	sumSq_heldout_n_move[b]=sum(((exp(predict_n_moveHeldOut)-1)-(exp(heldOut$cbcl_scr_syn_internal_r.y)-1))^2)
	# get AIC
	...
	sumSq_heldout_n_jail[b]=sum(((exp(predict_n_jailHeldOut)-1)-(exp(heldOut$cbcl_scr_syn_internal_r.y)-1))^2)
	# get AIC
	...
	sumSq_heldout_n_step[b]=sum(((exp(predict_n_stepHeldOut)-1)-(exp(heldOut$cbcl_scr_syn_internal_r.y)-1))^2)
	# get AIC
	...
	sumSq_heldout_n_new_job[b]=sum(((exp(predict_n_jobHeldOut)-1)-(exp(heldOut$cbcl_scr_syn_internal_r.y)-1))^2)
	# get AIC
	...
	sumSq_heldout_n_new_sib[b]=sum(((exp(predict_n_new_sibHeldOut)-1)-(exp(heldOut$cbcl_scr_syn_internal_r.y)-1))^2)
	# get AIC
	...
	sumSq_heldout_n_g[b]=sum(((exp(predict_n_gHeldOut)-1)-(exp(heldOut$cbcl_scr_syn_internal_r.y)-1))^2)
	# get AIC
	...
	sumSq_heldout_n_interview_age[b]=sum(((exp(predict_n_ageHeldOut)-1)-(exp(heldOut$cbcl_scr_syn_internal_r.y)-1))^2)
	# get AIC
	...
	sumSq_heldout_n_Grades[b]=sum(((exp(predict_n_gradesHeldOut)-1)-(exp(heldOut$cbcl_scr_syn_internal_r.y)-1))^2)
	# get AIC
	...
	sumSq_heldout_n_parentPcount[b]=sum(((exp(predict_n_parentPcountHeldOut)-1)-(exp(heldOut$cbcl_scr_syn_internal_r.y)-1))^2)
	# get AIC
	...
	sumSq_heldout_n_income[b]=sum(((exp(predict_n_incomeHeldOut)-1)-(exp(heldOut$cbcl_scr_syn_internal_r.y)-1))^2)
	# get AIC
	...
	sumSq_heldout_n_parental_education[b]=sum(((exp(predict_n_parental_educationHeldOut)-1)-(exp(heldOut$cbcl_scr_syn_internal_r.y)-1))^2)
	# get AIC
	...
	sumSq_heldout_n_sex[b]=sum(((exp(predict_n_sexHeldOut)-1)-(exp(heldOut$cbcl_scr_syn_internal_r.y)-1))^2)
	# get AIC
	...
	sumSq_heldout_n_race_ethnicity[b]<-sum(((exp(predict_n_race_ethnicityHeldout)-1)-(exp(heldOut$cbcl_scr_syn_internal_r.y)-1))^2)
	# get AIC
	...
	# get hMAE
	hMAE_n_race_ethnicity[b]=median(abs((exp(predict_n_race_ethnicityHeldout)-1)-(exp(heldOut$cbcl_scr_syn_internal_r.y)-1)))
	...
	# predict to get sum of squares
        ...
        sumSq_heldout_n_weight[b]=sum(((exp(predict_n_weightHeldOut)-1)-(exp(heldOut$cbcl_scr_syn_internal_r.y)-1))^2)
        # get AIC
	...
	# get hMAE
	hMAE_n_weight[b]=median(abs((exp(predict_n_weightHeldOut)-1)-(exp(heldOut$cbcl_scr_syn_internal_r.y)-1)))
	...
	# predict to get sum of squares
        ...
        sumSq_heldout_n_waist[b]=sum(((exp(predict_n_waistHeldOut)-1)-(exp(heldOut$cbcl_scr_syn_internal_r.y)-1))^2)
        # get AIC
	...
	# get hMAE
	hMAE_n_waist[b]=median(abs((exp(predict_n_waistHeldOut)-1)-(exp(heldOut$cbcl_scr_syn_internal_r.y)-1)))
	...
	# predict to get sum of squares
        ...
        sumSq_heldout_n_height[b]=sum(((exp(predict_n_heightHeldOut)-1)-(exp(heldOut$cbcl_scr_syn_internal_r.y)-1))^2)
        # get AIC
	...
	# get hMAE
	hMAE_n_height[b]=median(abs((exp(predict_n_heightHeldOut)-1)-(exp(heldOut$cbcl_scr_syn_internal_r.y)-1)))
	...
	# predict to get sum of squares
        ...
        sumSq_heldout_n_BMI[b]=sum(((exp(predict_n_BMIHeldOut)-1)-(exp(heldOut$cbcl_scr_syn_internal_r.y)-1))^2)
        # get AIC
	...
	# get hMAE
	hMAE_n_BMI[b]=median(abs((exp(predict_n_BMIHeldOut)-1)-(exp(heldOut$cbcl_scr_syn_internal_r.y)-1)))
...
saveRDS(outdf,'/oak/stanford/groups/leanew1/users/apines/data/gp/Int_TempPrec_IVE_sumSq.rds')
...
saveRDS(outdf,'/oak/stanford/groups/leanew1/users/apines/data/gp/Int_TempPrec_IVE_sumSqHeldout.rds')
...
saveRDS(outdf,'/oak/stanford/groups/leanew1/users/apines/data/gp/Int_TempPrec_IVE_DevExplained.rds')
...
saveRDS(outdf,'/oak/stanford/groups/leanew1/users/apines/data/gp/Int_TempPrec_IVE_AIC.rds')
...
saveRDS(outdf,'/oak/stanford/groups/leanew1/users/apines/data/gp/Int_TempPrec_IVE_BIC.rds')
...
saveRDS(stdbetas,'/oak/stanford/groups/leanew1/users/apines/data/gp/Int_TempPrec_IVE_betas.rds')
