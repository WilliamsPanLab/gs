...
for (b in 1:5000){
	...
	### age
	Model_n_age<-bam(cbcl_scr_syn_internal_r.y~cbcl_scr_syn_internal_r.x+ple_died_yBV.x+ple_died_y_IVE.y+ple_injured_yBV.x+ple_injured_y_IVE.y+ple_crime_yBV.x+ple_crime_y_IVE.y+ple_friend_yBV.x+ple_friend_y_IVE.y+ple_friend_injur_yBV.x+ple_friend_injur_y_IVE.y+ple_arrest_yBV.x+ple_arrest_y_IVE.y+ple_friend_died_yBV.x+ple_friend_died_y_IVE.y+ple_mh_yBV.x+ple_mh_y_IVE.y+ple_sib_yBV.x+ple_sib_y_IVE.y+ple_victim_yBV.x+ple_victim_y_IVE.y+ple_separ_yBV.x+ple_separ_y_IVE.y+ple_law_yBV.x+ple_law_y_IVE.y+ple_school_yBV.x+ple_school_y_IVE.y+ple_move_yBV.x+ple_move_y_IVE.y+ple_jail_yBV.x+ple_jail_y_IVE.y+ple_step_yBV.x+ple_step_y_IVE.y+ple_new_job_yBV.x+ple_new_job_y_IVE.y+ple_new_sib_yBV.x+ple_new_sib_y_IVE.y+s(g.x,k=4)+s(Grades.x,k=4)+s(parentPcount.x,k=4)+s(income.x,k=4)+s(parental_education.x,k=4)+sex.x+race_ethnicity.x+s(weight.x,k=4)+s(waist.x,k=4)+s(height.x,k=4)+s(BMI.x,k=4),data=bootSamp,family=nb())
	# predict to get sum of squares
	...
	### grades
	Model_n_grades<-bam(cbcl_scr_syn_internal_r.y~cbcl_scr_syn_internal_r.x+ple_died_yBV.x+ple_died_y_IVE.y+ple_injured_yBV.x+ple_injured_y_IVE.y+ple_crime_yBV.x+ple_crime_y_IVE.y+ple_friend_yBV.x+ple_friend_y_IVE.y+ple_friend_injur_yBV.x+ple_friend_injur_y_IVE.y+ple_arrest_yBV.x+ple_arrest_y_IVE.y+ple_friend_died_yBV.x+ple_friend_died_y_IVE.y+ple_mh_yBV.x+ple_mh_y_IVE.y+ple_sib_yBV.x+ple_sib_y_IVE.y+ple_victim_yBV.x+ple_victim_y_IVE.y+ple_separ_yBV.x+ple_separ_y_IVE.y+ple_law_yBV.x+ple_law_y_IVE.y+ple_school_yBV.x+ple_school_y_IVE.y+ple_move_yBV.x+ple_move_y_IVE.y+ple_jail_yBV.x+ple_jail_y_IVE.y+ple_step_yBV.x+ple_step_y_IVE.y+ple_new_job_yBV.x+ple_new_job_y_IVE.y+ple_new_sib_yBV.x+ple_new_sib_y_IVE.y+s(g.x,k=4)+s(interview_age.x,k=4)+s(parentPcount.x,k=4)+s(income.x,k=4)+s(parental_education.x,k=4)+sex.x+race_ethnicity.x+s(weight.x,k=4)+s(waist.x,k=4)+s(height.x,k=4)+s(BMI.x,k=4),data=bootSamp,family=nb())
	# predict to get sum of squares
	...
	### parentPcount
	Model_n_parentPcount<-bam(cbcl_scr_syn_internal_r.y~cbcl_scr_syn_internal_r.x+ple_died_yBV.x+ple_died_y_IVE.y+ple_injured_yBV.x+ple_injured_y_IVE.y+ple_crime_yBV.x+ple_crime_y_IVE.y+ple_friend_yBV.x+ple_friend_y_IVE.y+ple_friend_injur_yBV.x+ple_friend_injur_y_IVE.y+ple_arrest_yBV.x+ple_arrest_y_IVE.y+ple_friend_died_yBV.x+ple_friend_died_y_IVE.y+ple_mh_yBV.x+ple_mh_y_IVE.y+ple_sib_yBV.x+ple_sib_y_IVE.y+ple_victim_yBV.x+ple_victim_y_IVE.y+ple_separ_yBV.x+ple_separ_y_IVE.y+ple_law_yBV.x+ple_law_y_IVE.y+ple_school_yBV.x+ple_school_y_IVE.y+ple_move_yBV.x+ple_move_y_IVE.y+ple_jail_yBV.x+ple_jail_y_IVE.y+ple_step_yBV.x+ple_step_y_IVE.y+ple_new_job_yBV.x+ple_new_job_y_IVE.y+ple_new_sib_yBV.x+ple_new_sib_y_IVE.y+s(g.x,k=4)+s(interview_age.x,k=4)+s(Grades.x,k=4)+s(income.x,k=4)+s(parental_education.x,k=4)+sex.x+race_ethnicity.x+s(weight.x,k=4)+s(waist.x,k=4)+s(height.x,k=4)+s(BMI.x,k=4),data=bootSamp,family=nb())
	# predict to get sum of squares
	...
	### income
	Model_n_income<-bam(cbcl_scr_syn_internal_r.y~cbcl_scr_syn_internal_r.x+ple_died_yBV.x+ple_died_y_IVE.y+ple_injured_yBV.x+ple_injured_y_IVE.y+ple_crime_yBV.x+ple_crime_y_IVE.y+ple_friend_yBV.x+ple_friend_y_IVE.y+ple_friend_injur_yBV.x+ple_friend_injur_y_IVE.y+ple_arrest_yBV.x+ple_arrest_y_IVE.y+ple_friend_died_yBV.x+ple_friend_died_y_IVE.y+ple_mh_yBV.x+ple_mh_y_IVE.y+ple_sib_yBV.x+ple_sib_y_IVE.y+ple_victim_yBV.x+ple_victim_y_IVE.y+ple_separ_yBV.x+ple_separ_y_IVE.y+ple_law_yBV.x+ple_law_y_IVE.y+ple_school_yBV.x+ple_school_y_IVE.y+ple_move_yBV.x+ple_move_y_IVE.y+ple_jail_yBV.x+ple_jail_y_IVE.y+ple_step_yBV.x+ple_step_y_IVE.y+ple_new_job_yBV.x+ple_new_job_y_IVE.y+ple_new_sib_yBV.x+ple_new_sib_y_IVE.y+s(g.x,k=4)+s(interview_age.x,k=4)+s(Grades.x,k=4)+s(parentPcount.x,k=4)+s(parental_education.x,k=4)+sex.x+race_ethnicity.x+s(weight.x,k=4)+s(waist.x,k=4)+s(height.x,k=4)+s(BMI.x,k=4),data=bootSamp,family=nb())
	# predict to get sum of squares
	...
	### parental education
	Model_n_parental_education<-bam(cbcl_scr_syn_internal_r.y~cbcl_scr_syn_internal_r.x+ple_died_yBV.x+ple_died_y_IVE.y+ple_injured_yBV.x+ple_injured_y_IVE.y+ple_crime_yBV.x+ple_crime_y_IVE.y+ple_friend_yBV.x+ple_friend_y_IVE.y+ple_friend_injur_yBV.x+ple_friend_injur_y_IVE.y+ple_arrest_yBV.x+ple_arrest_y_IVE.y+ple_friend_died_yBV.x+ple_friend_died_y_IVE.y+ple_mh_yBV.x+ple_mh_y_IVE.y+ple_sib_yBV.x+ple_sib_y_IVE.y+ple_victim_yBV.x+ple_victim_y_IVE.y+ple_separ_yBV.x+ple_separ_y_IVE.y+ple_law_yBV.x+ple_law_y_IVE.y+ple_school_yBV.x+ple_school_y_IVE.y+ple_move_yBV.x+ple_move_y_IVE.y+ple_jail_yBV.x+ple_jail_y_IVE.y+ple_step_yBV.x+ple_step_y_IVE.y+ple_new_job_yBV.x+ple_new_job_y_IVE.y+ple_new_sib_yBV.x+ple_new_sib_y_IVE.y+s(g.x,k=4)+s(interview_age.x,k=4)+s(Grades.x,k=4)+s(parentPcount.x,k=4)+s(income.x,k=4)+sex.x+race_ethnicity.x+s(weight.x,k=4)+s(waist.x,k=4)+s(height.x,k=4)+s(BMI.x,k=4),data=bootSamp,family=nb())
	# predict to get sum of squares
	...
	### sex
	Model_n_sex<-bam(cbcl_scr_syn_internal_r.y~cbcl_scr_syn_internal_r.x+ple_died_yBV.x+ple_died_y_IVE.y+ple_injured_yBV.x+ple_injured_y_IVE.y+ple_crime_yBV.x+ple_crime_y_IVE.y+ple_friend_yBV.x+ple_friend_y_IVE.y+ple_friend_injur_yBV.x+ple_friend_injur_y_IVE.y+ple_arrest_yBV.x+ple_arrest_y_IVE.y+ple_friend_died_yBV.x+ple_friend_died_y_IVE.y+ple_mh_yBV.x+ple_mh_y_IVE.y+ple_sib_yBV.x+ple_sib_y_IVE.y+ple_victim_yBV.x+ple_victim_y_IVE.y+ple_separ_yBV.x+ple_separ_y_IVE.y+ple_law_yBV.x+ple_law_y_IVE.y+ple_school_yBV.x+ple_school_y_IVE.y+ple_move_yBV.x+ple_move_y_IVE.y+ple_jail_yBV.x+ple_jail_y_IVE.y+ple_step_yBV.x+ple_step_y_IVE.y+ple_new_job_yBV.x+ple_new_job_y_IVE.y+ple_new_sib_yBV.x+ple_new_sib_y_IVE.y+s(g.x,k=4)+s(interview_age.x,k=4)+s(Grades.x,k=4)+s(parentPcount.x,k=4)+s(income.x,k=4)+s(parental_education.x,k=4)+race_ethnicity.x+s(weight.x,k=4)+s(waist.x,k=4)+s(height.x,k=4)+s(BMI.x,k=4),data=bootSamp,family=nb())
	# predict to get sum of squares
	...
	### race
	Model_n_race_ethnicity<-bam(cbcl_scr_syn_internal_r.y~cbcl_scr_syn_internal_r.x+ple_died_yBV.x+ple_died_y_IVE.y+ple_injured_yBV.x+ple_injured_y_IVE.y+ple_crime_yBV.x+ple_crime_y_IVE.y+ple_friend_yBV.x+ple_friend_y_IVE.y+ple_friend_injur_yBV.x+ple_friend_injur_y_IVE.y+ple_arrest_yBV.x+ple_arrest_y_IVE.y+ple_friend_died_yBV.x+ple_friend_died_y_IVE.y+ple_mh_yBV.x+ple_mh_y_IVE.y+ple_sib_yBV.x+ple_sib_y_IVE.y+ple_victim_yBV.x+ple_victim_y_IVE.y+ple_separ_yBV.x+ple_separ_y_IVE.y+ple_law_yBV.x+ple_law_y_IVE.y+ple_school_yBV.x+ple_school_y_IVE.y+ple_move_yBV.x+ple_move_y_IVE.y+ple_jail_yBV.x+ple_jail_y_IVE.y+ple_step_yBV.x+ple_step_y_IVE.y+ple_new_job_yBV.x+ple_new_job_y_IVE.y+ple_new_sib_yBV.x+ple_new_sib_y_IVE.y+s(g.x,k=4)+s(interview_age.x,k=4)+s(Grades.x,k=4)+s(parentPcount.x,k=4)+s(income.x,k=4)+s(parental_education.x,k=4)+sex.x+s(weight.x,k=4)+s(waist.x,k=4)+s(height.x,k=4)+s(BMI.x,k=4),data=bootSamp,family=nb())
	# predict to get sum of squares
	...
	### weight
	Model_n_weight<-bam(cbcl_scr_syn_internal_r.y~cbcl_scr_syn_internal_r.x+ple_died_yBV.x+ple_died_y_IVE.y+ple_injured_yBV.x+ple_injured_y_IVE.y+ple_crime_yBV.x+ple_crime_y_IVE.y+ple_friend_yBV.x+ple_friend_y_IVE.y+ple_friend_injur_yBV.x+ple_friend_injur_y_IVE.y+ple_arrest_yBV.x+ple_arrest_y_IVE.y+ple_friend_died_yBV.x+ple_friend_died_y_IVE.y+ple_mh_yBV.x+ple_mh_y_IVE.y+ple_sib_yBV.x+ple_sib_y_IVE.y+ple_victim_yBV.x+ple_victim_y_IVE.y+ple_separ_yBV.x+ple_separ_y_IVE.y+ple_law_yBV.x+ple_law_y_IVE.y+ple_school_yBV.x+ple_school_y_IVE.y+ple_move_yBV.x+ple_move_y_IVE.y+ple_jail_yBV.x+ple_jail_y_IVE.y+ple_step_yBV.x+ple_step_y_IVE.y+ple_new_job_yBV.x+ple_new_job_y_IVE.y+ple_new_sib_yBV.x+ple_new_sib_y_IVE.y+s(g.x,k=4)+s(interview_age.x,k=4)+s(Grades.x,k=4)+s(parentPcount.x,k=4)+s(income.x,k=4)+s(parental_education.x,k=4)+sex.x+race_ethnicity.x+s(waist.x,k=4)+s(height.x,k=4)+s(BMI.x,k=4),data=bootSamp,family=nb())	
	# predict to get sum of squares
	...
	### waist
	Model_n_waist<-bam(cbcl_scr_syn_internal_r.y~cbcl_scr_syn_internal_r.x+ple_died_yBV.x+ple_died_y_IVE.y+ple_injured_yBV.x+ple_injured_y_IVE.y+ple_crime_yBV.x+ple_crime_y_IVE.y+ple_friend_yBV.x+ple_friend_y_IVE.y+ple_friend_injur_yBV.x+ple_friend_injur_y_IVE.y+ple_arrest_yBV.x+ple_arrest_y_IVE.y+ple_friend_died_yBV.x+ple_friend_died_y_IVE.y+ple_mh_yBV.x+ple_mh_y_IVE.y+ple_sib_yBV.x+ple_sib_y_IVE.y+ple_victim_yBV.x+ple_victim_y_IVE.y+ple_separ_yBV.x+ple_separ_y_IVE.y+ple_law_yBV.x+ple_law_y_IVE.y+ple_school_yBV.x+ple_school_y_IVE.y+ple_move_yBV.x+ple_move_y_IVE.y+ple_jail_yBV.x+ple_jail_y_IVE.y+ple_step_yBV.x+ple_step_y_IVE.y+ple_new_job_yBV.x+ple_new_job_y_IVE.y+ple_new_sib_yBV.x+ple_new_sib_y_IVE.y+s(g.x,k=4)+s(interview_age.x,k=4)+s(Grades.x,k=4)+s(parentPcount.x,k=4)+s(income.x,k=4)+s(parental_education.x,k=4)+sex.x+race_ethnicity.x+s(weight.x,k=4)+s(height.x,k=4)+s(BMI.x,k=4),data=bootSamp,family=nb())
	# predict to get sum of squares
	...
	### height
	Model_n_height<-bam(cbcl_scr_syn_internal_r.y~cbcl_scr_syn_internal_r.x+ple_died_yBV.x+ple_died_y_IVE.y+ple_injured_yBV.x+ple_injured_y_IVE.y+ple_crime_yBV.x+ple_crime_y_IVE.y+ple_friend_yBV.x+ple_friend_y_IVE.y+ple_friend_injur_yBV.x+ple_friend_injur_y_IVE.y+ple_arrest_yBV.x+ple_arrest_y_IVE.y+ple_friend_died_yBV.x+ple_friend_died_y_IVE.y+ple_mh_yBV.x+ple_mh_y_IVE.y+ple_sib_yBV.x+ple_sib_y_IVE.y+ple_victim_yBV.x+ple_victim_y_IVE.y+ple_separ_yBV.x+ple_separ_y_IVE.y+ple_law_yBV.x+ple_law_y_IVE.y+ple_school_yBV.x+ple_school_y_IVE.y+ple_move_yBV.x+ple_move_y_IVE.y+ple_jail_yBV.x+ple_jail_y_IVE.y+ple_step_yBV.x+ple_step_y_IVE.y+ple_new_job_yBV.x+ple_new_job_y_IVE.y+ple_new_sib_yBV.x+ple_new_sib_y_IVE.y+s(g.x,k=4)+s(interview_age.x,k=4)+s(Grades.x,k=4)+s(parentPcount.x,k=4)+s(income.x,k=4)+s(parental_education.x,k=4)+sex.x+race_ethnicity.x+s(weight.x,k=4)+s(waist.x,k=4)+s(BMI.x,k=4),data=bootSamp,family=nb())
	# predict to get sum of squares
	...
	### BMI
	Model_n_BMI<-bam(cbcl_scr_syn_internal_r.y~cbcl_scr_syn_internal_r.x+ple_died_yBV.x+ple_died_y_IVE.y+ple_injured_yBV.x+ple_injured_y_IVE.y+ple_crime_yBV.x+ple_crime_y_IVE.y+ple_friend_yBV.x+ple_friend_y_IVE.y+ple_friend_injur_yBV.x+ple_friend_injur_y_IVE.y+ple_arrest_yBV.x+ple_arrest_y_IVE.y+ple_friend_died_yBV.x+ple_friend_died_y_IVE.y+ple_mh_yBV.x+ple_mh_y_IVE.y+ple_sib_yBV.x+ple_sib_y_IVE.y+ple_victim_yBV.x+ple_victim_y_IVE.y+ple_separ_yBV.x+ple_separ_y_IVE.y+ple_law_yBV.x+ple_law_y_IVE.y+ple_school_yBV.x+ple_school_y_IVE.y+ple_move_yBV.x+ple_move_y_IVE.y+ple_jail_yBV.x+ple_jail_y_IVE.y+ple_step_yBV.x+ple_step_y_IVE.y+ple_new_job_yBV.x+ple_new_job_y_IVE.y+ple_new_sib_yBV.x+ple_new_sib_y_IVE.y+s(g.x,k=4)+s(interview_age.x,k=4)+s(Grades.x,k=4)+s(parentPcount.x,k=4)+s(income.x,k=4)+s(parental_education.x,k=4)+sex.x+race_ethnicity.x+s(weight.x,k=4)+s(waist.x,k=4)+s(height.x,k=4),data=bootSamp,family=nb())
	# predict to get sum of squares
