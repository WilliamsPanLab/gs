...
# load in data
masterdf=readRDS('/oak/stanford/groups/leanew1/users/apines/data/gp/gp_SCOp_masterdf.rds')
# FYI
...
saveRDS(outdf,'/oak/stanford/groups/leanew1/users/apines/data/gp/gp_SCOp_Boots.rds')
