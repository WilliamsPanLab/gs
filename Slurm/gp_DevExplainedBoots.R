...
for (b in 1:10000){
	...
	### law
	Model_n_law<-bam(cbcl_scr_syn_totprob_r~ple_died_y+ple_injured_y+ple_crime_y+ple_friend_y+ple_friend_injur_y+ple_arrest_y+ple_friend_died_y+ple_mh_y+ple_sib_y+ple_victim_y+ple_school_y+ple_move_y+ple_jail_y+ple_step_y+ple_new_job_y+ple_new_sib_y+s(g,k=4)+s(interview_age,k=4)+s(Grades,k=4)+s(parentPcount,k=4)+s(income,k=4)+s(parental_education,k=4)+sex+race_ethnicity,data=bootSamp,family=nb())
	...
	devExplained_n_job[b]=Model_n_job$deviance/Model_n_job$null.deviance
	### new sib
	...
	devExplained_n_age[b]=Model_n_age$deviance/Model_n_age$null.deviance
	### grades
	...
	### parentPcount
	Model_n_parentP<-bam(cbcl_scr_syn_totprob_r~ple_died_y+ple_injured_y+ple_crime_y+ple_friend_y+ple_friend_injur_y+ple_arrest_y+ple_friend_died_y+ple_mh_y+ple_sib_y+ple_victim_y+ple_separ_y+ple_law_y+ple_school_y+ple_move_y+ple_jail_y+ple_step_y+ple_new_job_y+ple_new_sib_y+s(g,k=4)+s(interview_age,k=4)+s(Grades,k=4)+s(income,k=4)+s(parental_education,k=4)+sex+race_ethnicity,data=bootSamp,family=nb())
	devExplained_n_parentP[b]=Model_n_parentP$deviance/Model_n_parentP$null.deviance
	### income
	...
	### parental education
	Model_n_parental_edu<-bam(cbcl_scr_syn_totprob_r~ple_died_y+ple_injured_y+ple_crime_y+ple_friend_y+ple_friend_injur_y+ple_arrest_y+ple_friend_died_y+ple_mh_y+ple_sib_y+ple_victim_y+ple_separ_y+ple_law_y+ple_school_y+ple_move_y+ple_jail_y+ple_step_y+ple_new_job_y+ple_new_sib_y+s(g,k=4)+s(interview_age,k=4)+s(Grades,k=4)+s(parentPcount,k=4)+s(income,k=4)+sex+race_ethnicity,data=bootSamp,family=nb())
	devExplained_n_parental_edu[b]=Model_n_parental_edu$deviance/Model_n_parental_edu$null.deviance
	### sex
